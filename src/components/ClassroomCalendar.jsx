        ...
        {roomStatus && (
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              ...
              >
                فترات متاحة ({examDuration}h): {roomStatus.freeCount} من{" "}
                {roomStatus.totalCount} | محجوزة: {roomStatus.busyCount}
              </div>
            </div>
            <Label
